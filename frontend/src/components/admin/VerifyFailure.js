...
export default function VerifyFailure() {
  ...
  const failMessage = location.state;
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <QR state="failure" giftName={giftData ? giftData.giftName : ''} />
        <StatusMessage
          situation="verification"
          status="failure"
          desc={giftData ? t.stateDesc[giftData.stateDesc] : ''}
          giftName={giftData ? giftData.giftName : ''}
        />
      </div>
    </>
  );
